...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/public/css/attendance.css') }}"><!--cssのフォルダ位置ファイル位置によって読み込み不可になる-->
    <link rel="stylesheet" href="{{ asset('/public/css/common_header-attendance.css') }}">
